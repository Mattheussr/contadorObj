...
image_res, image_thresh = cv2.threshold(
    image_blur_gray, 190, 255, cv2.THRESH_BINARY)
...
ret, last_image_bright = cv2.threshold(
...
image_res2, image_thresh2 = cv2.threshold(
    image_blur_gray, 150, 255, cv2.THRESH_BINARY_INV)
...
ret, last_image_dark = cv2.threshold(
    dist_transform2, 0.1 * dist_transform2.max(), 255, 0)
